...
//#define TEST_MAXRECTS
#define TEST_GUILLOTINE
//#define TEST_SKYLINE
...
#endif
#ifdef TEST_GUILLOTINE
	GuillotineBinPack *pack = new GuillotineBinPack(1024*8, 1024*8, true);
#endif
#ifdef TEST_SKYLINE
	SkylineBinPack *pack = new SkylineBinPack(1024*8, 1024*8, false);
#endif
...
#endif
#ifdef TEST_SKYLINE
		Rect r = pack->Insert(a, b, SkylineBinPack::LevelBottomLeft);
#endif
#ifdef TEST_GUILLOTINE
		Rect r = pack->Insert(
			a
